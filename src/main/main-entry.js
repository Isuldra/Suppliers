...
try {
  ...
  setupDatabaseHandlers = () => log.warn('Database handlers setup skipped due to import error');
  closeDatabaseConnection = () => log.warn('Database connection close skipped due to import error');
}
