...
PACKAGE CONTENTS:
----------------
1. onemed-supplychain-Setup.exe - Standard Windows installer
2. onemed-supplychain-Setup.msi - MSI package for enterprise deployment
3. onemed-supplychain-Portable.zip - Portable version (no installation required)
...
--------------------------------------------------------
- Double-click the "Sonemed-supplychain-Setup.exe" file
...
------------------------------------------------
- Double-click the "onemed-supplychain-Setup.msi " file
- Follow the installation wizard prompts
...
---------------------------------------------------
1. Extract the "onemed-supplychain-Portable.zip" file to any location
2. Open the extracted folder
3. Run "onemed-supplychain-Setup.exe" or the included batch file
